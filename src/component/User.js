            ...
            {loader ? <Loader /> : <table>
                ...
                {user.map((each, index) => (
                    <tr key={index}>
                        ...
                        <td>{each.email}</td>
                        <td>{each.age}</td>
                        <td><button className="btn btn-primary" onClick={() => updateHelper(each.id)}>Update</button></td>
                        <td><button className="btn btn-danger" onClick={() => deleteHandler(each.id)}>Delete</button></td>
                    </tr>
                ))}
            </table>}
        </div>
