                    ...
                    <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
                        {({ setFieldValue, values }) => (
                            <Form>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="anniversary_date" className="form-label">Anniversary Date:</label>
                    ...
                    <div>
                        <div className="image-upload">
                            <label htmlFor="fileInput" className="d-inline-block mb-3">
                                ...
                                <img src={selectPhoto} alt="Dummy Human" className="human-image" style={{ width: '100px', height: '100px' }} />
                            </label>
                        </div>
                        <div className="btn-group mb-3" role="group" aria-label="Basic example">
                            <button type="button" className="btn btn-primary btn-sm me-1">Add</button>
