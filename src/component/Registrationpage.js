...
export default function Registrationpage() {
    ...
    return (
        <div>
            <div className="registration-form" style={{ height: "140vh" }}>
                <Formik
                    initialValues={{
                        name: '',
                        email: '',
                        ...
                        <Form>
                            ...
                            <div className="form-group mb-10" style={{ marginBottom: "25px" }}>
                                ...
                                {errors.mobno && touched.mobno ? (
                                    <div className='error'>{errors.mobno}</div>
                                ) : null}
                            </div>

                            <div className="form-group mb-10" style={{ marginBottom: "25px" }}>
                                <Field as="select" className="form-control item" id="userType" placeholder="UserType" name="userType" onChange={(e) => {
                            ...
                            {showBrandDescription && ( 
                                <div className="form-group mb-10" style={{ marginBottom: "25px" }}>
                                    <Field type="text" className="form-control item" id="brandDescription" placeholder="Brand Description" name="brandDescription" />
                            ...
                            <div className="form-group">
                                <button type="submit" className="btn btn-block create-account" disabled={!isValid}>Create Account</button>
                            </div>
                            <div className="links">
